# Brendan's PMDAS Expression Parser

For our final project, I wrote a mathematical expression parser in assembly.
...
This is a **broad simplification** of the parser. The real thing is about 1400 lines of assembly. You are free to read through that.
...
To make certain things easier, like choosing what operation to perform based on a character, I came up with a simple switch statement implementation.
